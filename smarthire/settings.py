...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-h!*$b!g%uruuxdz4%yvz$x(2#4-o*0fd(3@=6oalx&9fcje1s=')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = 'RENDER' not in os.environ

ALLOWED_HOSTS = ['*'] # Allowed all for simplicity, you can restrict this later
...
# If DATABASE_URL is set (e.g. Aiven database URL on Render), use it
